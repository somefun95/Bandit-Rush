...
bool RenderSystem::init(int width, int height, GLFWwindow* window_arg)
{
    this->is_play = false;
    this->is_over = false;
    this->offset1 = {0.f,-2.f};
    this->offset2 = {0.f,-2.f};
    this->offset3 = {0.f,-2.f};
    this->offset4 = {0.f,-2.f};
    this->offset5 = {0.f,-2.f};
	this->window = window_arg;
    this->tutorial_pause = true;
	...
	//int major = gl3w__version.major;
	int check = gl3w_is_supported(3, 2);
	assert(is_fine == 0);
